...
module MultimediaHelper
  include AsyncTasks
    ...
    video.screenshot( (File.expand_path File.dirname(__FILE__) + '/../../public' + thumbnail_path), { seek_time: seek_time, custom: '-vf "scale=\'if(lt(a,200/120),200,-1)\':\'if(lt(a,200/120),-1,120)\', crop=200:120"' } )
  ...
  def generateImageThumbnail(imagePath)
    ...
    thumb.write(File.expand_path File.dirname(__FILE__) + '/../../public' + thumbnail_path)
